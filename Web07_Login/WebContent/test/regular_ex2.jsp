...
<script>
	// 공백이 아닌 한 글자가 1번이상 반복되는 문자열(단어)을 모두 추출할 수 있는 정규표현식 객체
	var reg=/[^ ]+/g; //공백이 아닌 한글자가 1번이상 반복되는 문자열 -> 한 단어 이상을 의미. g는 찾으려는 글자 전체에서 다 찾겠다는 의미.
	...
	$("#sendBtn").on("click", function(){
		...
		while(true){
			...
			alert(result);
			//li 요소를 만들어서 단어를 출력하고 #wordList 에 추가하기
