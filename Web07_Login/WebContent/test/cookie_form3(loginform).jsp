<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- 
	"로그인 정보 저장"이라는 체크박스 누르고 로그인 할 시
	쿠키로 저장해놨다가 다음에 loginform으로 들어오면 자동으로
	저장했던 쿠키에 내용들을 input 요소에 뿌려주고
	"로그인 정보 저장" 체크박스를 클릭하지 않고 로그인 할 시
	쿠키 정보가 사라지면서 loginform 페이지로 들어오면
	input 요소에는 비어있게 된다.
--%>
<%
