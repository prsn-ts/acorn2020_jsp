...
<script>
	...
	function pasteHTML() {
		...
		oEditors.getById["content"].exec("PASTE_HTML", [sHTML]); //textarea 의 ID값과 같이(content)로 해야한다.
	}
	
	function showHTML() {
		var sHTML = oEditors.getById["content"].getIR(); //textarea 의 ID값과 같이(content)로 해야한다.
		alert(sHTML);
	}
